            ...
            <div class="content">
               <?php
                  ...
                  if(isset($_REQUEST["reprun"]) && $_REQUEST["reprun"] == "yes"){
                  	...
                  	$sorturl=htmlentities($_SERVER['PHP_SELF']. "?reprun=yes&sp_dd=".$_REQUEST['sp_dd']);
               ...
               <table class="new_search_tbl" cellpadding="0" cellspacing="0" width="100%">
                  ...
                  <?php
                     ...
                     $main_qry = "Select companyInfo.ID, companyInfo.company, companyInfo.city, companyInfo.state, employees.initials AS EI from companyInfo LEFT OUTER JOIN employees ON companyInfo.assignedto = employees.employeeID  where ".$str." sales_purc_team_ignore_com=1 and companyInfo.status not in (31,24,86, 49) ";
