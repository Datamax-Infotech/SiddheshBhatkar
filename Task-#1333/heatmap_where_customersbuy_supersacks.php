...
<html>
	<head>
		...
		<title>Heat Map: Supersack Customers</title>
		...
		<div class="main_data_css">
			...
			<div class="dashboard_heading" style="float: left;">
				...
				<div style="float: left;">
					...
					Heat Map: Supersack Customers

					<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>

						<span class="tooltiptext">This heat map shows the user where all B2B supersack customers are located, counted over the lifetime of UCB.</span>
					</div>
			...
			<?php
				...
				$sql_z = "SELECT latitude, longitude, cnt from heatmap_supersacks_temp_tbl where report_name='heatmap_where_cust_buy_supersacks'";
			...
			<div class="title_css"><strong>B2B Map to show where customers buy Supersacks</strong></div>
			...
			<?php
				...
				$sql = "SELECT variablevalue from tblvariable where variablename = 'heatmap_supersacks_cron_run_date'";
			...
			<div id="no-more-tables">
				...
				<table>
					...
					<?php
						...
						$sql_z = "SELECT zip, cnt from heatmap_supersacks_temp_tbl where report_name='heatmap_where_cust_buy_supersacks' order by cnt desc";
