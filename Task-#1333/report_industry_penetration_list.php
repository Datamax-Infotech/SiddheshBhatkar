  ...
  <body>
    ...
    <div class="main_data_css">
      ...
      <?php
        ...
        ?>
      <tr valign="middle">
        <td width="15%" bgcolor="<?php echo $rowcolor?>"><font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $MGArraytmp2["industry"]?></font></td>
      ...
      <tr>
        ...
        <td bgcolor="#D9F2FF" align="center"><font size="1" face="Arial, Helvetica, sans-serif" color="#333333">Total Profit&nbsp;<a href="<?php echo $sorturl; ?>&sort_order_pre=ASC&sort=totprofit"><img src="images/sort_asc.png" width="6px;" height="12px;"></a>&nbsp;<a href="<?php echo $sorturl; ?>&sort_order_pre=DESC&sort=totprofit"><img src="images/sort_desc.png" width="6px;" height="12px;"></a>
          </font>
        </td>
      </tr>
      <?php
        	...
        	$MGArray = array();	
        ...
        
        		{
         		...
         		$unqid = $unqid + 1;
        			...
        			?>
      <tr valign="middle">
        <td width="200px" bgcolor="<?php echo $rowcolor?>"><a target="_blank" href="viewCompany.php?ID=<?php echo $data["I"]?>"><font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php if ($data["LID"] > 0) echo "<b>"; ?><?php echo $nickname; ?><?php if ($data["LID"] > 0) echo "</b>"; ?></font></a></td>
        <td width="50px" bgcolor="<?php echo $rowcolor?>" align="center"><font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $data["EI"]?></font></td>
        <td width="100px" bgcolor="<?php echo $rowcolor?>" align="center"><font face="Arial, Helvetica, sans-serif" size="1" color="#333333"><?php echo $industry?></font></td>
      ...
      <tr>
        ...
        <td bgcolor="#D9F2FF" align="center"><?php echo number_format(($total_noocontacted*100)/$total_nooflocation_insystem,2);?>%</td>
        <td bgcolor="#D9F2FF" align="center"><?php echo number_format(($total_noquoted*100)/$total_nooflocation_insystem,2);?>%</td>
        <td bgcolor="#D9F2FF" align="center"><?php echo number_format(($total_nosold*100)/$total_nooflocation_insystem,2);?>%</td>
