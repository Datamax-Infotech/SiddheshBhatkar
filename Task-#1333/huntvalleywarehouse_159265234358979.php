...
<?php
   ...
   $urlRefresh = huntvalleywarehousepage();
      ...
      <script LANGUAGE="JavaScript">
...

         {
...

         	{
         		...
         		window.location = "<?php echo huntvalleywarehousepage()?>";
...

         {
         	...
         	xmlhttp.open("GET","inventory_displayucbinv_warehouse.php?colid=" + colid + "&wid=18"+ "&sortflg=" + sortflg ,true);	
   ...
   <body onload="JavaScript:timedRefresh(1200000);">
      ...
      <?php
...

         {
         	...
         	$sql3ud = "UPDATE loop_transaction SET pr_recycling = 1, pa_warehouse = 18, mark_as_recycling_by = '".$_COOKIE['employeeid']."', mark_as_recycling_on ='".date("Y-m-d H:i:s")."' WHERE id = '". $_REQUEST["conf_id"] . "'";
         		...
         		if ($rec_bypass == "no") {
					...
					db();
...

                     {
         				...
         				echo "window.location.href=\"https://loops.usedcardboardboxes.com/huntvalleywarehouse_159265234358979.php?onlyshow_timeclock=" . $_REQUEST["onlyshow_timeclock"] . "\";";

         				echo "</script>";

         				echo "<noscript>";

         				echo "<meta http-equiv=\"refresh\" content=\"0;url=https://loops.usedcardboardboxes.com/huntvalleywarehouse_159265234358979.php?onlyshow_timeclock=" . $_REQUEST["onlyshow_timeclock"] . "\" />";
      ...
      <td valign="top">
      <!--------------- EMPLOYEE TABLE ---------------->
      <form method="post" action="<?php echo huntvalleywarehousepage()?>" onsubmit="return chkssn();">
      ...
      <option value="-1">Select Worked</option>
      <?php
      ...
      <?php
...

         {
         	...
         	?>
      <form method="post" action="<?php echo huntvalleywarehousepage()?>" onsubmit="return chkssn_logout(<?php echo $row["A"]?>);">
      ...
      SSN (last 4 digit) <input type="password" name="ssn_txt_logout" id="ssn_txt_logout<?php $row["A"]?>" value="" size="4"/>
				...
				db();
...

         		{
					...
					db();
         			...
         			?>
      <?php
         $arrLeaderboardHunvalley[] = array('efficiency' => $efficiency, 'name' => $name, "hourrate" => $hourrate, 'totalhours' => $hours, 'production' => $tot_production );
      ...
      <b>PRODUCTION LEADERBOARD <?php echo $dttitle;?> - <?php echo date('m/d/Y');?></b> &nbsp; <a href="huntvalleywarehouse_leaderboard.php" target="_blank">History</a></td>
      </tr>
      <tr>
      ...
      <?php
         array_multisort(array_column($arrLeaderboardHunvalley, 'production'), SORT_DESC, array_column($arrLeaderboardHunvalley, 'efficiency'), SORT_DESC,

         				array_column($arrLeaderboardHunvalley, 'totalhours'), SORT_DESC, array_column($arrLeaderboardHunvalley, 'name'), SORT_ASC, $arrLeaderboardHunvalley);
      ...
      <?php echo $color .  $arrLeaderboardHunvalleyV["name"]; ?></font></td>
      <td bgColor="#e4e4e4" class="style3"  align="center">	
      ...
      <td bgColor="#e4e4e4" class="style3"  align="center">	
      <?php echo $color . "$" . number_format($arrLeaderboardHunvalleyV["production"],2); 
         ?>
      </font></td>
      <td bgColor="#e4e4e4" class="style3"  align="center">	
      <?php 
         $money_lost = str_replace(",", "", number_format($arrLeaderboardHunvalleyV["production"],2)) - (str_replace(",", "", number_format($arrLeaderboardHunvalleyV["hourrate"],2))* str_replace(",", "", number_format($arrLeaderboardHunvalleyV["totalhours"],2)));
      ...
      <a href="https://b2c.usedcardboardboxes.com/pending_shipments.php?tbl=huntvally&fromdash=y&posting=yes" target="_blank"><?php echo $count_pc2; ?></a>
      </td>
      <td bgColor="#e4e4e4" class="style12" style="width: 10%">
      <a href="https://b2c.usedcardboardboxes.com/shipments_shipped.php?tbl=huntvally&posting=yes&fromdash=y" target="_blank"><?php echo $count_pc_tot_for_day2; ?></a>
      </td>
      <!-- <td bgColor="#e4e4e4" class="style12" style="width: 10%">
      ...
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a target="_blank" href="http://loops.usedcardboardboxes.com/hr_page.php?warehouse_id=18&onlyshow_timeclock=yes"><b>WRITE TO HR</b></a>
         </td>
      </tr>
      <?php } ?>	
      <?php if ($onlyshow_timeclock == "no") { ?>	
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a href="https://loops.usedcardboardboxes.com/huntvalleywarehouse_159265234358979.php?onlyshow_timeclock=yes"><b>TIMECLOCK COMPUTER PAGE</b></a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a href="http://loops.usedcardboardboxes.com/report_timeclock_production_add.php?location_dd=1&show_data=Submit"><b>ENTER PRODUCTION</b></a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a href="http://loops.usedcardboardboxes.com/report_hunt_valley_inventory.php"><b>INVENTORY COUNT SHEET</b></a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a href="http://loops.usedcardboardboxes.com/deletewarehousetransaction.php">REMOVE DUPLICATE TRAILERS</a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
      ...
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a target="_blank" href="http://loops.usedcardboardboxes.com/hr_page.php?warehouse_id=18"><b>WRITE TO HR</b></a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
      ...
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
            <a target="_blank" href="report_search_processed_inbound_trailers.php?sorting_warehouse=18"><b>Search Processed Inbound Trailers</b></a>
         </td>
      </tr>
      <tr>
         <td bgColor="#e4e4e4" class="style12center" >
                  ...
                  <script LANGUAGE="JavaScript">
                     ...
                     function undodelivery(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo huntvalleywarehousepage()?>?action=undodelivery&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undorecycling(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo huntvalleywarehousepage()?>?action=undorecycling&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undoucblot(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo huntvalleywarehousepage()?>?action=undoucblot&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undoucbdockdoor(trailerno, recid) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo huntvalleywarehousepage()?>?action=undoucbdockdoor&conf_id="+recid+"&trailer_no="+trailerno;
            ...
            <td valign="top">
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     ...
                     $query_2.= " WHERE (delivery_dock_appt_empby <>'' and delivery_dock_appt_ignore = 0) and pa_warehouse = 18 AND (pr_ucblot = 0 and srt_dockdoors_flg = 0)";
      ...
      <table cellSpacing="1" cellPadding="1" border="0" width="570">
      <tr align="middle">
      <td class="style7" colspan="3" style="height: 16px"><strong>SALE ORDER DETAILS FOR ORDER ID: <?php echo $row["wid"]?></strong></td>
      </tr>
      <tr vAlign="center">
      <td bgColor="#e4e4e4" width="70" class="style17" ><font size=1>
      <strong>QTY</strong></font></td>
      ...
      <form action="<?php echo huntvalleywarehousepage();?>" name="frmeod" id="frmeod" method="post">
      <table>
      <tr>
