<?php
   ...
   $location_address="UCB - Integra Supply Portland, OR";
  
   function integrasupplyportlandwarehousepage()
   {
   
   	return "https://loops.usedcardboardboxes.com/integrasupplyportland_5749865412.php";
   
   }
   
   ?>
<?php
   //5750 UCB - Integra Supply Portland, OR
   
   $urlRefresh = integrasupplyportlandwarehousepage();
   
   //header("Refresh: 10; URL=".integrasupplyportlandwarehousepage()); // redirect in 5 seconds
   
   $IN_LIST = "3747"; //trailers in TO BE PROCESSED table
   $oldest_date = ""; // Defined - Siddhesh
   $trs_id = ""; // Defined - Siddhesh
   ?>
<!DOCTYPE html">
<html>
   <title>Integra Supply Portland - Dashboard</title>
   <head>
      <style type="text/css">
      ...
      <script LANGUAGE="JavaScript">
         ...
         if (answer){
         	...
         	window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=request&req_id="+b+"&trailer_no="+a+"&dock="+encodeURIComponent(c);
         ...
         if (answer){
         	...
         	window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=confirm&conf_id="+b+"&trailer_no="+a+"&dock="+encodeURIComponent(c);
         ...
         if (answer){
         	...
         	window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=undoucbdockdoor&conf_id="+recid+"&trailer_no="+trailerno;
         ...
         if (answer){
         	...
         	window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=recycling&conf_id="+b+"&trailer_no="+a+"&dock="+encodeURIComponent(c);
         ...
         if (answer){
         	...
         	window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=ucblot&conf_id="+b+"&trailer_no="+a+"&dock="+encodeURIComponent(c);
         ...
         
         {
         ...
         
         	{
         		...
         		window.location = "<?php echo integrasupplyportlandwarehousepage()?>";
         ...
         
         {
         ...
         
         	{
         		...
         		xmlhttp.open("POST","pending_shipment_isp.php",true);
         ...
         
         {
         ...
         
         	{
         		...
         		xmlhttp.open("POST","inv_integrasupplyport.php",true);
         ...
         function undodelivery(trailerno, recid, dockno) {
         	...
         	if (answer){
         		...
         		window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=undodelivery&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
         ...
         
         {
         	...
         	xmlhttp.open("GET","inventory_displayucbinv_warehouse.php?colid=" + colid + "&wid=5750"+ "&sortflg=" + sortflg ,true);	
   ...
   <script type="text/javascript"> 
      ...
      function undorecycling(trailerno, recid, dockno) {
      	...
      	if (answer){
      		...
      		window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=undorecycling&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
      ...
      function undoucblot(trailerno, recid, dockno) {
      	...
      	if (answer){
      		...
      		window.location = "<?php echo integrasupplyportlandwarehousepage()?>?action=undoucblot&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
   ...
   <body onload="JavaScript:timedRefresh(1200000);">
      ...
      <?php
         if (isset($_REQUEST["btnqtyofkitship"])){
         	...
         	if ($_REQUEST["hd_warehouse"] == "hk"){
         		...
         		$warehouse_name = "Integra Supply Portland, OR";
         ...
         
         {
         	...
         	$sql3ud = "UPDATE loop_transaction SET pa_warehouse = '5750', bol_file = 'No BOL', bol_employee = 'UCB-HK', bol_date = '".date("m/d/Y")."', pa_pickupdate = '".date("m/d/Y")."' WHERE id = '". $_REQUEST["conf_id"] . "'";
			...
			db();
         	...
         	integrasupplyportlandwarehousepage() ;
         ...
         
         {
         	...
         	$sql3ud = "UPDATE loop_transaction SET pr_recycling = 1, pa_warehouse = 5750, mark_as_recycling = '1', mark_as_recycling_by = '".$_COOKIE['employeeid']."', mark_as_recycling_on ='".date("Y-m-d H:i:s")."' WHERE id = '". $_REQUEST["conf_id"] . "'";
         ...
         
         {
         	...
         	$sql3ud = "UPDATE loop_transaction SET pr_ucblot = 1, pa_warehouse = 5750, pr_ucblot_by='".$_COOKIE['userinitials']."', pr_ucblot_dt='".$ucblot_dt."' , pr_ucblot_note='".$pr_ucblot_note."' WHERE id = '". $_REQUEST["conf_id"] . "'";
      ...
      <table border="0">
         <tr>
            ...
            <td align=center width="50%">
               ...
               <b><i>UCB - Integra Supply Portland, OR</i></b>
               </i>
            </td>
         ...
         <tr>
            <td colSpan="2" valign="top">
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     ...
                     $query = "SELECT *, loop_transaction.id AS A, loop_warehouse.id as wid FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.pa_warehouse = 5750 and loop_transaction.cp_notes = '' AND bol_employee LIKE ''  AND pr_recycling = 0 and pr_ucblot = 0 and srt_dockdoors_flg=0 and loop_transaction.ignore = 0 ORDER BY loop_transaction.ID ASC";
               ...
               <br><Br>
               <?php
                  $query = "SELECT *, loop_transaction.id AS A FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.ignore = 0 and pa_warehouse = 5750 and ((loop_transaction.cp_notes = '' AND pr_ucblot = 1 AND srt_dockdoors_flg=0 AND bol_employee LIKE '') or (srt_dockdoors_flg =1 AND ucbunloaded_flg=0) or (ucbunloaded_flg=1 AND (sort_entered = 0 or usr_file LIKE ''))) ORDER BY loop_transaction.ID ASC";
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     //warehouse_id IN ( " . $IN_LIST . " ) and
                     
                     $tablerow_color="";
                     
                     $query = "SELECT *, loop_transaction.id AS A FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.ignore = 0 and pa_warehouse = 5750 and loop_transaction.cp_notes = '' AND pr_ucblot = 1 AND srt_dockdoors_flg=0 AND bol_employee LIKE '' ORDER BY loop_transaction.ID ASC";
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     ...
                     $query = "SELECT *, loop_transaction.id AS A FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.ignore = 0 and pa_warehouse = 5750 and loop_transaction.cp_notes = ''  AND pr_recycling = 1 AND ucbunloaded_flg=0 AND bol_employee LIKE '' ORDER BY loop_transaction.ID ASC";
            ...
            <td vAlign="top">
               ...
               <div id="indockdoor">
                  <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                     ...
                     <tr align="center">
                        ...
                        <td  align="center" bgColor="<?php echo $tablerow_color?>" class="style3">	
                           <input type=button value="UNLOADED" id="btnDelivered<?php echo $rec_id?>" style="cursor:pointer;" onclick="confirmationUnloaded_new('<?php echo $row["pr_trailer"]; ?>','<?php echo $rec_id?>','<?php echo $row["pr_dock"]?>','5750')" >
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color?>" class="style3">	
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     $query = "SELECT *, loop_warehouse.warehouse_name AS CN, loop_transaction.id AS LTID FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.ignore = 0 and (pa_warehouse = 5750) and pa_pickupdate <> '' and cp_date <> '' AND ucbunloaded_flg=1 AND (sort_entered = 0 or usr_file LIKE '') AND transaction_date > '2010-10-28' ORDER BY loop_transaction.ID ASC";
            ...
            <td valign="top">
               <table cellSpacing="1" cellPadding="1" border="0" width="700px;">
                  ...
                  <?php
                     ...
                     $query.= " AND loop_transaction_buyer.id > 67 and location_warehouse_id = 5750";
                     ...
                     $query_1.= " AND loop_transaction_buyer.id > 67 and location_warehouse_id = 5750";
      ...
      <div id="diveod" style="display:none;">
         <form action="<?php echo integrasupplyportlandwarehousepage();?>" name="frmeod" id="frmeod" method="post">
            <table>
               <tr>
