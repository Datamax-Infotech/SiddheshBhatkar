        ...
        <table width="1400px">
          ...
          <tr style="background: #2B1B17;">
            ...
            <td bgcolor="#C0CDDA" align="middle">
              <a href="report_boxesorder_reminder.php?sort_fld=last_order_date&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">
                Last Delivery Date
            </td>
            ...
            <td bgcolor="#C0CDDA" align="middle">
              <a href="report_boxesorder_reminder.php?sort_fld=avg_time_order&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">
