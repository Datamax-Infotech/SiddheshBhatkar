	...
	<body>
		...
		<div class="main_data_css">
			...
			<div>
				<form method="POST" name="frm" id="frm" action="<?php echo $_SERVER['PHP_SELF']; ?>">
					<table>
						<tr>
							<td>Query:</td>
							<td><select name="order_dd" id="order_dd">
			...
			?>
					...
					<form method="post" name="sp_report_new">
						<table width="1400px">
							...
							<tr style="background: #2B1B17;">
								...
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=company_name&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Company Name</a></td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=last_order_date&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Last Delivery Date</td>

								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=totorder&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Total # of Orders</a></td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=totorderval&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Total Revenue (to-date)</a></td>

								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=avg_time_order&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Average Days Between Orders</td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=no_days&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA"># of Days Since Last Order</td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=rep_name&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Account Owner</td>

								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=acc_status&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Status</td>

								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=lastcontactdt&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Last Contact Date</a></td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=nextstep&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Next Step</a></td>
								<td bgcolor="#C0CDDA" align="middle"><a href="report_boxesorder_reminder.php?sort_fld=nextstepdt&sort_order_pre=<?php echo $sort_order_pre; ?>&order_dd=<?php echo $_REQUEST["order_dd"]; ?>" bgcolor="#C0CDDA">Next Communication</a></td>
							</tr>
							<?php
					...
					where rec_type = 'Supplier' and Active = 1 and max_transaction_cnt > 1 and b2bid > 0 and (last_delivery_date is not null and last_delivery_date <> '0000-00-00') 
					order by company_name");
						...
						status, active, nickname from companyInfo where active = 1 and status not in (31, 24, 43) and ID = " . $main_row["b2bid"];
										...
										if ($inactive_company == "y") {
											...
											if ($_REQUEST["order_dd"] == "2") {
												...
												if ($newflg == "yes" && $newflg1 == "yes") {
													db_b2b();
													$sql_comp = "Select companyInfo.company, assignedto, employees.name, nickname from companyInfo inner join employees on companyInfo.assignedto = employees.employeeID where ID = '" . $main_row["b2bid"] . "'";
													$dt_view_res = db_query($sql_comp);
													$emp_name = "";
											...
											if ($_REQUEST["order_dd"] == "1") {
												...
												if ($newflg == "yes") {
													db_b2b();
													$sql_comp = "Select companyInfo.company, assignedto, employees.name from companyInfo inner join employees on companyInfo.assignedto = employees.employeeID where ID = '" . $main_row["b2bid"] . "'";
													$dt_view_res = db_query($sql_comp);
													$emp_name = "";
													$newcompany = $row['company_name'];
													while ($row_comp = array_shift($dt_view_res)) {
							...
							?>
									<tr id="main_div<?php echo $cnt_no ?>">
										...
										<td bgcolor="#E4E4E4"><b><a style="color:#006600" href="http://loops.usedcardboardboxes.com/viewCompany.php?ID=<?php echo $MGArraytmp2["compid"]; ?>" target="_blank">
							...
							if (isset($_REQUEST["sort_fld"])) {
								...
								?>
									<tr id="main_div<?php echo $cnt_no ?>">
										...
										<td bgcolor="#E4E4E4"><b><a style="color:#006600" href="http://loops.usedcardboardboxes.com/search_results.php?id=<?php echo $MGArraytmp2["warehouse_id"]; ?>&proc=View&searchcrit=&rec_type=Supplier&page=0" target="_blank">
													<font size='2'><?php echo $MGArraytmp2["company_name"]; ?></font>
												</a></b></td>
