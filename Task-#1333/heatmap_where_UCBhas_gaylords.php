...
<html>
	<head>
		...
		<title>Heat Map: Gaylord Suppliers </title>
		...
		<div class="main_data_css">
			...
			<div class="dashboard_heading" style="float: left;">
				...
				<div style="float: left;">
					...
					Heat Map: Gaylord Suppliers

					<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>

						<span class="tooltiptext">This heat map shows the user where all B2B gaylord suppliers are located, counted over the lifetime of UCB.</span>
					</div>
			...
			<?php
				...
				$sql_z = "SELECT latitude, longitude, cnt from heatmap_gaylords_temp_tbl where report_name='heatmap_where_UCBhas_gylord'";
			...
			<div class="title_css"><strong>B2B Map to show where UCB has gaylords</strong></div>
			...
			<div id="no-more-tables">
				...
				<table>
					...
					<?php
						...
						$sql_z = "SELECT zip, cnt from heatmap_gaylords_temp_tbl where report_name='heatmap_where_UCBhas_gylord' order by cnt desc";
