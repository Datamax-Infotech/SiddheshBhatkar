...
<html>
	<head>
		...
		<title>Heat Map: Shipping Box Suppliers</title>
		...
		<div class="main_data_css">
			...
			<div class="dashboard_heading" style="float: left;">
				...
				<div style="float: left;">
					...
					Heat Map: Shipping Box Suppliers

					<div class="tooltip"><i class="fa fa-info-circle" aria-hidden="true"></i>

						<span class="tooltiptext">This heat map shows the user where all B2B shipping box suppliers are located, counted over the lifetime of UCB.</span>
					</div>
			...
			<?php
				...
				$sql_z = "SELECT latitude, longitude, cnt from heatmap_shippingbox_temp_tbl where report_name='heatmap_where_UCBhas_shipping'";
			...
			<div class="title_css"><strong>B2B Map to show where UCB has Shipping Boxes</strong></div>
			...
			<div id="no-more-tables">
				...
				<table>
					...
					<?php
						...
						$sql_z = "SELECT zip, cnt from heatmap_shippingbox_temp_tbl where report_name='heatmap_where_UCBhas_shipping' order by cnt desc";
