<?php
   ...
   ?>
<?php 
   $warehouse_id_list_str  = "15 ,2449"; 
   
   $warehouse_id_list_str2 = "15 ,2449";
   
   $warehouse_id_list_str3 = "15 ,2449";
   
   	
   
   $location_address="Canusa Hershman Production";	
   
   
   
   function canusahershmanwarehousepage(): string
   
   {
   
   	return "canusahershmanwarehouse_1614835009.php";
   ...
   function canusahershmanwarehouse(): string
   
   {
   
   	if (!headers_sent()){    
   
           header('Location: https://loops.usedcardboardboxes.com/canusahershmanwarehouse_1614835009.php'); exit;
   ...
   
   	{
           ...
           echo "window.location.href=\"https://loops.usedcardboardboxes.com/canusahershmanwarehouse_1614835009.php\";";
   
           echo "</script>";
   
           echo "<noscript>";
   
           echo "<meta http-equiv=\"refresh\" content=\"0;url=https://loops.usedcardboardboxes.com/canusahershmanwarehouse_1614835009.php\" />";
   ...
   $urlRefresh = canusahershmanwarehousepage();
   
   $get_all_red_row_cnt = 0;
   
   $CH_red_row_loop_ids_str = "";
...
<html>
   <title>Canusa Hershman - Dashboard</title>
   <head>
      <style type="text/css">
         body{ margin:0 auto; padding:5px 10px;}
      ...
      <script language="JavaScript">
         ...
         if (answer){
         	...
         	window.location = "<?php echo canusahershmanwarehousepage()?>?action=request&req_id="+b+"&trailer_no="+a+"&dock="+c;
         ...
         
         {
         ...
         
         	{
         		...
         		window.location = "<?php echo canusahershmanwarehousepage()?>";
         ...
         if (answer){
         	...
         	window.location = "<?php echo canusahershmanwarehousepage()?>?action=confirm&conf_id="+b+"&trailer_no="+a+"&dock="+c;
         ...
         if (answer){
         	...
         	window.location = "<?php echo canusahershmanwarehousepage()?>?action=recycling&conf_id="+b+"&trailer_no="+a+"&dock="+c;
         ...
         if (answer){
         	...
         	window.location = "<?php echo canusahershmanwarehousepage()?>?action=ucblot&conf_id="+b+"&trailer_no="+a+"&dock="+c;
         ...
         if(document.getElementById("pending_ship").innerHTML == "")
         	...
         	xmlhttp.open("POST","pending_shipment_canusahershman.php",true);
         ...
         
         {
         ...
         
         	{
         		...
         		xmlhttp.open("POST","inv_canusahershman.php",true);
         ...
         
         {
         ...
         
         	{
         		...
         		xmlhttp.open("POST","report_b2c_inventory_for_dashboard.php?whid=6",true);
         ...
         
         {
         	...
         	xmlhttp.open("GET","inventory_displayucbinv_warehouse.php?colid=" + colid + "&wid=4146"+ "&sortflg=" + sortflg ,true);	
   ...
   <body onload="JavaScript:timedRefresh(1200000);">
      ...
      <?php
		 ...
		 if (isset($_REQUEST["btnqtyofkitship"])){
         	...
         	if ($_REQUEST["hd_warehouse"] == "ch"){
         
         		$warehouse_name = "Hunt Valley";
         
         		$sql_pc = "SELECT * FROM `orders_active_ucb_canusahershman` inner join orders on orders.orders_id = orders_active_ucb_canusahershman.orders_id WHERE ship_status LIKE 'Y' and DATE_FORMAT(date_purchased, '%Y-%m-%d') = '" . date("Y-m-d") . "'";
         		...
         		$sql_pc = "SELECT * FROM `orders_active_ucb_canusahershman` where ship_status LIKE 'N'";
         ...
         
         {
         	...
         	$recipient = "canusahershman@usedcardboardboxes.com, davidkrasnow@usedcardboardboxes.com, martymetro@usedcardboardboxes.com";
         	...
         	$sql3ud = "UPDATE loop_transaction SET pa_warehouse = '4146', bol_file = 'No BOL', bol_employee = 'UCB-CH', bol_date = '".date("m/d/Y")."', pa_pickupdate = '".date("m/d/Y")."' WHERE id = '". $_REQUEST["conf_id"] ."'";
         
         	$result3ud = db_query($sql3ud);
         
         
         
         	$sql3ud = "UPDATE loop_transaction SET cp_notes = 'Delivery Confirmed via Warehouse Dashboard', cp_employee = 'UCB-CH', cp_date = '".date("m/d/Y")."' WHERE id = '". $_REQUEST["conf_id"] ."'";
         	...
         	$ucbunloaded_note="Entered via warehouse[CH] dashboard";
         ...
         
         {
         	...
         	$sql3ud = "UPDATE loop_transaction SET pr_recycling = 1, pa_warehouse = 4146 WHERE id = '". $_REQUEST["conf_id"] . "'";
         ...
         
         {
         	...
         	$pr_ucblot_note = "Entered via warehouse [CH] dashboard";
         
         	//
         
         	$sql3ud = "UPDATE loop_transaction SET pr_ucblot = 1, pa_warehouse = 4146, pr_ucblot_by='".$_COOKIE['userinitials']."', pr_ucblot_dt='".$ucblot_dt."' , pr_ucblot_note='".$pr_ucblot_note."' WHERE id = '". $_REQUEST["conf_id"] . "'";
         ...
         
         {
         	...
         	$ucbunloaded_note="Entered from warehouse[CH] dashboard";
         ...
         
         {
         ...
         
         	{
         		...
         		if ($rec_bypass == "no") {
         			...
         			$sql3ud = "INSERT INTO loop_timeclock (`worker_id` ,`warehouse_id` ,`time_in`, `location_address`, `type`, `ipaddress`) VALUES ('" . $_REQUEST["worker"] . "', '4146', NOW() + INTERVAL 1 HOUR, '" . $location_address . "', '" . $_REQUEST["type"] . "', '" . $_SERVER["REMOTE_ADDR"] . "')";
         
         			db();
         			$result3ud = db_query($sql3ud);
         
         			
                     $ipcheckqery="select * from timeclock_check_ip where loop_warehouse_id=4146 and ipaddress='".$_SERVER["REMOTE_ADDR"]."'";
         ...
         
         {
             ...
             $fraud_email.= "Location:  <b>UCB - CH</b> <br><br>";
      ...
      <table border="0">
         <tr>
            <td valign="top">
               <!--------------- REQUESTED TABLE ---------------->
               <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                  <tr align="middle">
                     ...
                     
                     {
                     ...
                     
                     	{
                     ...
                     
                     		{
                     			...
                     			$CH_red_row_loop_ids_str = $CH_red_row_loop_ids_str . $row["rec_id"] . ",";
               ...
               <?php
                  ...
                  $query = "SELECT *, loop_transaction.id AS A FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.ignore = 0 and pa_warehouse = 4146 and ((loop_transaction.cp_notes = '' AND pr_ucblot = 1 AND srt_dockdoors_flg=0 AND bol_employee LIKE '') or (srt_dockdoors_flg =1 AND ucbunloaded_flg=0) or (ucbunloaded_flg=1 AND (sort_entered = 0 or usr_file LIKE ''))) ORDER BY loop_transaction.ID ASC";
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                  ...
                  <?php
                     $query = "SELECT *, loop_transaction.id AS A, loop_warehouse.id as wid FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.pa_warehouse = 4146 and loop_transaction.cp_notes = '' AND srt_dockdoors_flg=0 AND bol_employee LIKE '' AND pr_ucblot = 1 and loop_transaction.ignore = 0 ORDER BY loop_transaction.ID ASC";
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                  ...
                  <?php
                     $query = "SELECT *, loop_transaction.id AS A, loop_warehouse.id as wid FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE loop_transaction.pa_warehouse = 4146 and srt_dockdoors_flg = 0 and loop_transaction.cp_notes = '' AND bol_employee LIKE '' AND pr_recycling = 1 and loop_transaction.ignore = 0 AND ucbunloaded_flg=0 ORDER BY loop_transaction.ID ASC";
                  ...
                  <tr align="center">
                     ...
                     <td  align="center" bgColor="<?php echo $tablerow_color?>" class="style3">
                        <div id="dockdoor_<?php echo $row["rec_id"]?>">			
                           <input type=button value="Delivered" style="cursor:pointer;" onclick="fn_delivered_to_dock('<?php echo $row["pr_trailer"]; ?>','<?php echo $row["rec_id"]?>','false','<?php echo $wh_name; ?>')" >
                        </div>
                     </td>
                     <td align="center" bgColor="<?php echo $tablerow_color?>" class="style3">	
            ...
            <td colspan="2" align="left" valign="top">
               ...
               <div id="indockdoor">
                  <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                        ...
                        
                        		{
                        ...
                        
                        			{
                        ...
                        
                        				{
                        					...
                        					$CH_red_row_loop_ids_str = $CH_red_row_loop_ids_str . $row["LTID"] . ",";
                     ...
                     <tr align="center">
                        ...
                        <td  align="center" bgColor="<?php echo $tablerow_color?>" class="style3">	
                           <input type=button value="UNLOADED" id="btnDelivered<?php echo $rec_id?>" style="cursor:pointer;" onclick="confirmationUnloaded_new('<?php echo $row["pr_trailer"]; ?>','<?php echo $rec_id?>','<?php echo $row["pr_dock"]?>','4146')" >
                        </td>
                        <td align="center" bgColor="<?php echo $tablerow_color?>" class="style3">	
               ...
               <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                  ...
                  <script LANGUAGE="JavaScript">
                     ...
                     function undodelivery(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo canusahershmanwarehousepage()?>?action=undodelivery&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undorecycling(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo canusahershmanwarehousepage()?>?action=undorecycling&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undoucblot(trailerno, recid, dockno) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo canusahershmanwarehousepage()?>?action=undoucblot&conf_id="+recid+"&trailer_no="+trailerno+"&dock="+dockno;
                     ...
                     function undoucbdockdoor(trailerno, recid) {
                     	...
                     	if (answer){
                     		...
                     		window.location = "<?php echo canusahershmanwarehousepage()?>?action=undoucbdockdoor&conf_id="+recid+"&trailer_no="+trailerno;
                  ...
                  <?php
                     $query = "SELECT *, loop_warehouse.warehouse_name AS CN, loop_warehouse.id as wid , loop_transaction.id AS LTID FROM loop_transaction INNER JOIN loop_warehouse ON loop_transaction.warehouse_id = loop_warehouse.id WHERE (pa_warehouse = 4146) and pa_pickupdate <> '' AND ucbunloaded_flg=1  AND (sort_entered = 0 or usr_file LIKE '') AND transaction_date > '2010-10-28' and loop_transaction.ignore = 0 ORDER BY loop_transaction.ID ASC";
                  ...
                  <tr align="center">
                     ...
                     <td bgColor="<?php echo $tablerow_color?>" class="style3">				
                        ...
                        <?php } else {?>
                        <input type="button" value="Print Report" onClick="printsortrep('<?php echo $row["LTID"] ?>' , '<?php echo $row["manulasortrep_print"]; ?>')">				<?php }?>
                     </td>
                     <!-- Added by Mooneem 07-14-12  -->
                     <td bgColor="<?php echo $tablerow_color?>" class="style3">
            ...
            <td valign="top">
               <table cellSpacing="1" cellPadding="1" border="0" width="650px;">
                  ...
                  <?php
                     ...
                     $query.= " AND loop_transaction_buyer.id > 67 and location_warehouse_id = 4146";
                     ...
                     
                     {
                     	...
                     	$ins_qry_1 = "INSERT INTO canusahershman_temp (`type` , `trid` , `wid` , `warehousename` , `date` , `time` , `picklist_print`) VALUES ('Outbound','" . $rows["trid"] . "', '" . $rows["wid"] . "', '" . str_replace("'", "\'" , $rows["warehousename"]) . "', '" .$rows["date"]. "', '" . $rows["time"]. "', '" . $rows["picklist_print"] . "')";
                     ...
                     $query_1.= " AND loop_transaction_buyer.id > 67 and location_warehouse_id = 4146 ";
                     ...
                     
                     {
                     ...
                     
                     	{
                     		...
                     		$ins_qry_2 = "INSERT INTO canusahershman_temp (`type` , `trid` , `wid` , `warehousename` , `date` , `time` , `picklist_print`) VALUES ('Outbound','" . $row_1["trid"] . "', '" . $row_1["wid"] . "', '" . str_replace("'", "\'" , $row_1["warehousename"]) . "', '" .$row_1n["date"]. "', '" . $row_1n["time"]. "', '" . $row_1n["picklist_print"] . "')";
                     ...
                     $qry = "select * from canusahershman_temp order by date asc";
                  ...
                  <tr vAlign="center">
                     ...
                     <td bgColor="<?php echo $bgColor_val; ?>" class="style3"  align="center">
                        <p align="center">
                           <span class="infotxt_freight ">
                              <u><a href="http://loops.usedcardboardboxes.com/search_results.php?warehouse_id=<?php echo $row["wid"]?>&rec_type=Supplier&proc=View&searchcrit=&id=<?php echo $row["wid"]?>&rec_id=<?php echo $row["trid"];?>&display=buyer_ship"><?php echo getnickname($row["warehousename"], $row["wid"]);?></a></u>
                     ...
                     <?php
                        ...
                        ?>
                     <td bgColor="<?php echo $bgColor_val; ?>" class="style3"  align="center"><?php echo $row["date"];?></td>
                     <?php
                        }
                  ...
                  <?php
                     ...
                     db();
                     db_query("DELETE FROM canusahershman_temp");	
      ...
      <?php
         ...
         
         {
             ...
             ?>
      <tr class="<?php echo $bgclass; ?>" id="so<?php if(isset($rows["wid"])){ echo $rows["wid"];}else{ echo "";}?>">
      <td class="style3" >
      ...
      <table cellSpacing="1" cellPadding="1" border="0" width="570">
      <tr align="middle">
      <td class="style7" colspan="3" style="height: 16px"><strong>SALE ORDER DETAILS FOR ORDER ID: <?php if(isset($row["wid"])){ echo $row["wid"]; }else{ echo "";}?></strong></td>
      </tr>
      <tr vAlign="center">
      <td bgColor="#e4e4e4" width="70" class="style17" ><font size=1>
      <strong>QTY</strong></font></td>
      ...
      <?php
         if ($_REQUEST["action"] == 'run') {
			...
			$end_date = date('Ymd', strtotime($end_date) + 86400);
      ...
      <a href="huntvalleywarehouse_159265234358979.php"><b>UCB - Hunt Valley</b></a>
      </td>
      </tr>
      </table>
      <div id="diveod" style="display:none;">
      <form action="<?php echo canusahershmanwarehousepage();?>" name="frmeod" id="frmeod" method="post">
      <table>
      <tr>
      ...
      <?php 
         $query = "Update tblvariable set variablevalue = '" . $get_all_red_row_cnt . "' where variablename = 'CH_red_row_cnt'";
         
         $res = db_query($query);
         
         
         
         if ($CH_red_row_loop_ids_str != ""){
         
         	$CH_red_row_loop_ids_str = substr($CH_red_row_loop_ids_str, 0 , strlen($CH_red_row_loop_ids_str)-1);	
         
         	$query = "Update tblvariable set variablevalue = '" . $CH_red_row_loop_ids_str . "' where variablename = 'CH_red_row_loop_ids'";
